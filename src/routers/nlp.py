...
import logging
from routers.schemas.nlp import PushRequest,SearchRequest
...
async def index_project(request:Request,project_id:str,puch_request:PushRequest):
    ...
    if puch_request.do_reset:
        _=nlp_controller.reset_vector_db_collection(project=project)
