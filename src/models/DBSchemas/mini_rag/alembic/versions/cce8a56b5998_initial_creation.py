...
Revision ID: cce8a56b5998
Revises: 
Create Date: 2026-04-09 20:09:56.559296
...
def upgrade() -> None:
    ...
    sa.Column('asset_created_at', sa.DateTime(timezone=True), server_default='now()', nullable=False),
    sa.Column('asset_updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index('ix_asset_name', 'assets', ['asset_name'], unique=False)
    op.create_index('ix_asset_project_id', 'assets', ['asset_project_id'], unique=False)
    op.create_index('ix_asset_project_id_name', 'assets', ['asset_project_id', 'asset_name'], unique=True)
    ...
    op.create_index('ix_chunk_order', 'chunks', ['chunk_order'], unique=False)
    op.create_index('ix_chunk_project_id', 'chunks', ['chunk_project_id'], unique=False)
    op.create_index('ix_chunk_project_id_order', 'chunks', ['chunk_project_id', 'chunk_order'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_chunk_project_id_order', table_name='chunks')
    op.drop_index('ix_chunk_project_id', table_name='chunks')
    op.drop_index('ix_chunk_order', table_name='chunks')
    op.drop_index('ix_chunk_asset_id', table_name='chunks')
    op.drop_table('chunks')
    op.drop_index('ix_asset_type', table_name='assets')
    op.drop_index('ix_asset_project_id_name', table_name='assets')
    op.drop_index('ix_asset_project_id', table_name='assets')
    op.drop_index('ix_asset_name', table_name='assets')
